...
import { Typography, Box, makeStyles, TableContainer, Table, TableBody, TableCell, TableHead, TableRow, Paper, IconButton, Tooltip
                            ...
                            <TableBody>
                                {
                                    ...
                                    <TableCell align="center">
                                        ...
                                        <Tooltip title="Delete">
                                            <IconButton onClick={()=>handleDelete(student.id)}><Link to="./delete/1"><DeleteIcon color="secondary" /></Link></IconButton>
                                        </Tooltip>
